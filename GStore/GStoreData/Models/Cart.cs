...
namespace GStoreData.Models
{
	...
	public class Cart : BaseClasses.StoreFrontRecordUserProfileOptional
	{
		...
		[Display(Name = "Name", Description = "Your Full Name entered at checkout.")]
		...
		[ForeignKey("CartPaymentInfoId")]
		public virtual CartPaymentInfo CartPaymentInfo { get; set; }
		...
		public bool StatusPaymentInfoConfirmed { get; set; }
		...
		[Display(Name = "Cart Bundles", Description = "Bundles of products in the cart.")]
		public virtual ICollection<CartBundle> CartBundles { get; set; }

		[Display(Name = "Attempted Payments", Description = "Payment Attempts for this cart.")]
