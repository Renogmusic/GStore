...
namespace GStoreData.Models
{
	...
	[Table("SmsSent")]
	public class SmsSent : BaseClasses.EventLogBase
	{
		[Key]
	...
	[Table("EmailSent")]
	public class EmailSent : BaseClasses.EventLogBase
	{
		[Key]
		public int EmailSentId { get; set; }
	...
	public enum UserActionActionEnum : int
	{
		...
		[Display(Name = "", Description = "", GroupName = "Catalog")]
		Catalog_ViewBundle = 20030,

		[Display(Name = "", Description = "", GroupName = "Catalog")]
		Catalog_ViewBundleNotFound = 20031,
		...
		[Display(Name = "", Description = "", GroupName = "Checkout")]
		Checkout_ConfirmedPaymentInfo = 30050,
		...
		[Display(Name = "", Description = "", GroupName = "Order Status")]
		Orders_ReceiptSentToEmail = 60050,
