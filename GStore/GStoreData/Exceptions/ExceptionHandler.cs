...
namespace GStoreData.Exceptions
{
	...
	public static class ExceptionHandler
	{
		...
		public static bool HandleInvalidOperationException(InvalidOperationException ex, bool clearError, HttpContext context, RouteData routeData, BaseController controller)
		{
			string rawUrl = context.Request.RawUrl;
			string url = context.Request.Url.ToString();
			if (Settings.AppLogSystemEventsToDb || Settings.AppLogSystemEventsToFile)
		...
		public static bool HandleNoMatchingBindingException(NoMatchingBindingException ex, bool clearError, HttpContext context, RouteData routeData, BaseController controller)
		{
			if (Settings.AppEnableBindingAutoMapToFirstStoreFront && !RepositoryFactory.SystemWideRepository(controller.User).StoreFronts.IsEmpty())
			{
		...
		public static bool HandleStoreFrontInactiveException(StoreFrontInactiveException ex, bool clearError, HttpContext context, RouteData routeData, BaseController controller)
		{
			string rawUrl = context.Request.RawUrl;
			string url = context.Request.Url.ToString();
			if (Settings.AppLogSystemEventsToDb || Settings.AppLogSystemEventsToFile)
		...
		public static bool HandleUnknownException(Exception ex, bool clearError, HttpContext context, RouteData routeData, BaseController controller)
		{
			string rawUrl = context.Request.RawUrl;
			string url = context.Request.Url.ToString();
			if (Settings.AppLogSystemEventsToDb || Settings.AppLogSystemEventsToFile)
		...
		private static void LogAppException(ApplicationException ex, HttpContext context, RouteData routeData, BaseController controller)
		{
		...
		private static void LogInvalidOperationException(InvalidOperationException ex, HttpContext context, RouteData routeData, BaseController controller)
		{
		...
		private static void LogUnknownException(Exception ex, HttpContext context, RouteData routeData, BaseController controller)
		{
		...
		private static void LogFileNotFound(Exception ex, HttpContext context, RouteData routeData, BaseController controller)
		{
			string source = ex.Source;
			IGstoreDb db = RepositoryFactory.SystemWideRepository(context.User);
