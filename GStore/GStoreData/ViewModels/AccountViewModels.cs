...
namespace GStoreData.ViewModels
{
	...
	{
		[Required]
		[Display(Name = "Email", Description = "Enter your Email Address to log in.", Prompt="Enter your Email Address")]
		[EmailAddress]
		public string Email { get; set; }

		[Required]
		[DataType(DataType.Password)]
		[Display(Name = "Password", Description = "Enter your Password to log in", Prompt = "Enter your Password")]
	...
	public class RegisterViewModel
	{
		[Required]
		[EmailAddress]
		[Display(Name = "Email", Description = "Enter your Email Address", Prompt = "Enter your Email Address")]
		public string Email { get; set; }

		[Required]
		[Display(Name = "Your Name", Description = "Enter your Full Name. \nExample: John Doe", Prompt = "Enter your Full Name")]
		public string FullName { get; set; }

		[Required]
		[StringLength(100, ErrorMessage = "The {0} must be at least {2} characters long.", MinimumLength = 6)]
		[DataType(DataType.Password)]
		[Display(Name = "Password", Description = "Enter a Password for this site", Prompt = "Choose a Password")]
		public string Password { get; set; }

		[DataType(DataType.Password)]
		[Display(Name = "Confirm password", Description = "Confirm your Password", Prompt = "Confirm your Password")]
		...
		[Display(Name = "Leave us a note", Description = "Leave us a message to help us assist you better", Prompt = "Leave us a note")]
