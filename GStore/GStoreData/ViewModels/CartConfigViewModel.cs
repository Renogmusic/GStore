...
namespace GStoreData.ViewModels
{
	...
	public class CartConfigViewModel
	{
		...
		[Display(Name = "Show Bundled Items", Description = "Check this box to show bundled items. Uncheck this box to show only the bundle as a product and not the individual items.")]
		public bool CartBundleShowIncludedItems { get; set; }

		[Display(Name = "Show Price of Bundled Items", Description = "Check this box to show the price of each bundled item. Uncheck this box to show '(included)'")]
