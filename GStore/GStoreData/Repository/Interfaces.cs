...
namespace GStoreData
{
	...
	public interface IGstoreDb
	{
		...
		[Display(Name = "Cart Bundles", Description = "Bundles of products in shopping cart for a store front.")]
		IGStoreRepository<Models.CartBundle> CartBundles { get; }
		...
		[Display(Name = "Cart Payment Infos", Description = "Payment Info entered at checkout in an order for a store front.")]
		IGStoreRepository<Models.CartPaymentInfo> CartPaymentInfos { get; }
		...
		[Display(Name = "Emails Sent", Description = "Events logged for emails being sent off the system.")]
		IGStoreRepository<Models.EmailSent> EmailsSent { get; }
		...
		[Display(Name = "Order Bundles", Description = "Bundles in an order for a store front.")]
		IGStoreRepository<Models.OrderBundle> OrderBundles { get; }
		...
		[Display(Name = "Payments", Description = "Payments that have actually been processed for an order for a store front.")]
		...
		[Display(Name = "Product Bundle Items", Description = "Product Bundle Items for items in a product bundle with a specific price for a store front.")]
		IGStoreRepository<Models.ProductBundleItem> ProductBundleItems { get; }
		...
		[Display(Name = "SMS Messages Sent", Description = "Events logged for SMS Messages being sent off the system.")]
		IGStoreRepository<Models.SmsSent> SmssSent { get; }
