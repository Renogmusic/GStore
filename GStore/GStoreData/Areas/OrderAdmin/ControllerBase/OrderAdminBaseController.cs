...
using GStoreData.Areas.OrderAdmin.ViewModels;
using GStoreData.Models;

namespace GStoreData.Areas.OrderAdmin.ControllerBase
{
	[Identity.AuthorizeGStoreAction(Identity.GStoreAction.Admin_OrderAdminArea)]
	public abstract class OrderAdminBaseController : GStoreData.ControllerBase.BaseController
	{
