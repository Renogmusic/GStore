...
namespace GStoreData.Areas.SystemAdmin
{
	...
	/// </summary>
	public static class SystemAdminActivationExtensions
	{
		public static bool ActivateClientOnly(this SystemAdminBaseController controller, int clientId)
		{
		...
		public static bool ActivatePageTemplate(this SystemAdminBaseController controller, int pageTemplateId)
		{
