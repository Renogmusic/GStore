...
{
	public class ValueListAdminController : AreaBaseController.StoreAdminAreaBaseController
	{
		...
		public ActionResult DeleteConfirmed(int? id)
		{
			...
			try
			{
				...
				if (deleted)
				{
					AddUserMessage("Value List Deleted", "Value List '" + valueListName.ToHtml() + "' [" + id + "] was deleted successfully. Value List Items deleted: " + valueListItemsToDelete.Count + ".", UserMessageType.Success);
					return RedirectToAction("Manager");
				}
				AddUserMessage("Value List Delete Error", "There was an error deleting Value List '" + valueListName.ToHtml() + "' [" + id + "]. It may have already been deleted.", UserMessageType.Warning);
				return RedirectToAction("Manager");
			...
			catch (Exception ex)
			{
				...
				AddUserMessage("Value List Delete Error", errorMessage.ToHtml(), UserMessageType.Danger);
				return RedirectToAction("Manager");
			}
		}
	}
