...
{
	public class UserProfileSysAdminController : AreaBaseController.SystemAdminAreaBaseController
	{
		...
		public ActionResult Edit(UserProfile profile, bool? clientIdChanged)
		{
			if (ModelState.IsValid && !(clientIdChanged ?? false))
			{
				...
				AddUserMessage("User Profile Updated", "User Profile '" + profile.FullName.ToHtml() + "' &lt;" + profile.Email.ToHtml() + " &gt; [" + profile.UserProfileId + "] updated successfully!", UserMessageType.Success);
				GStoreDb.SaveChanges();
		...
		public ActionResult DeleteConfirmed(int id)
		{
			try
			{
				...
				GStoreDb.SaveChanges();
				AddUserMessage("User Profile deleted", "User Profile Id [" + id + "] was deleted successfully.", UserMessageType.Info);
			}
			catch (Exception ex)
			{
