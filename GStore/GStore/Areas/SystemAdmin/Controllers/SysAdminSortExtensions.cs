...
namespace GStore.Areas.SystemAdmin.Controllers
{
	...
	/// </summary>
	public static class SysAdminSortExtensions
	{
		public static IOrderedQueryable<Client> ApplySort(this BaseClasses.SystemAdminBaseController controller, IQueryable<Client> query, string SortBy, bool? SortAscending)
		{
		...
		public static IOrderedQueryable<StoreBinding> ApplySort(this BaseClasses.SystemAdminBaseController controller, IQueryable<StoreBinding> query, string SortBy, bool? SortAscending)
		{
			string sortBy = (string.IsNullOrEmpty(SortBy) ? string.Empty : SortBy.Trim().ToLower());
			bool sortAscending = (SortAscending.HasValue ? SortAscending.Value : true);
				...
				case "":
					...
					else
					{
						orderedQuery = query.OrderByDescending(c => c.Order)
							...
							.ThenByDescending(sf => sf.StoreFrontId)
			...
			if (!defaultSort && sortAscending)
			{
				return orderedQuery.ThenBy(c => c.Order)
							.ThenBy(c => c.ClientId)
							.ThenBy(sb => sb.StoreFront.Order)
							.ThenBy(sf => sf.StoreFrontId)
							.ThenBy(sb => sb.Order)
			...
			{
				return orderedQuery.ThenByDescending(c => c.Order)
					.ThenByDescending(c => c.ClientId)
					.ThenByDescending(sb => sb.StoreFront.Order)
					.ThenByDescending(sf => sf.StoreFrontId)
					.ThenByDescending(sb => sb.Order)
		...
		public static IOrderedQueryable<StoreFront> ApplySort(this BaseClasses.SystemAdminBaseController controller, IQueryable<StoreFront> query, string SortBy, bool? SortAscending)
		{
			string sortBy = (string.IsNullOrEmpty(SortBy) ? string.Empty : SortBy.Trim().ToLower());
			bool sortAscending = (SortAscending.HasValue ? SortAscending.Value : true);
