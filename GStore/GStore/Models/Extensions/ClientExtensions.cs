...
namespace GStore.Models.Extensions
{
	public static class ClientExtensions
	{
		...
		public static bool IsActiveDirect(this BaseClasses.ClientLiveRecord record)
		{
			return record.IsActiveDirect(DateTime.UtcNow);
		}
		public static bool IsActiveDirect(this BaseClasses.ClientLiveRecord record, DateTime dateTime)
		{
