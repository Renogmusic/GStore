...
namespace GStore.Models.Extensions
{
	public static class EventLogExtensions
	{
		...
		/// </summary>
		/// <returns></returns>
		public static string SimpleInfo(this BaseClasses.EventLogBase record, int maxMessageLength = 80)
		{
		...
		public static void SetBasicFields(this BaseClasses.EventLogBase record, HttpContextBase httpContext, RouteData routeData, string source, string message, bool anonymous, UserProfile profile, Controllers.BaseClass.BaseController controller)
		{
