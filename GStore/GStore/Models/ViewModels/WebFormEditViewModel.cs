...
{
	public class WebFormEditViewModel
	{
		public WebFormEditViewModel()
		{
		}
		...
		public void FillFieldsFromViewModel(WebForm webFormToUpdate, WebFormFieldEditViewModel[] webFormFields)
		{
		...
		public WebFormFieldEditViewModel[] webFormFieldPostData { get; protected set; }
		...
		public List<WebFormFieldEditViewModel> WebFormFieldEditViewModels()
		{
		...
		protected List<WebFormFieldEditViewModel> _webFormFieldViewModels = null;
