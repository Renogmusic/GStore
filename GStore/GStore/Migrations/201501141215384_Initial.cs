    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        CartLayoutName = c.String(nullable: false, maxLength: 10),
                        ...
                        CheckoutLayoutName = c.String(nullable: false, maxLength: 10),
                        ...
                        OrderStatusLayoutName = c.String(nullable: false, maxLength: 10),
                        OrderStatusThemeId = c.Int(nullable: false),
                        OrderAdminLayoutName = c.String(nullable: false, maxLength: 10),
                        OrderAdminThemeId = c.Int(nullable: false),
                        CatalogAdminLayoutName = c.String(nullable: false, maxLength: 10),
                        ...
                        DefaultNewPageLayoutName = c.String(nullable: false, maxLength: 10),
                        CatalogLayoutName = c.String(nullable: false, maxLength: 10),
                        AccountLayoutName = c.String(nullable: false, maxLength: 10),
                        ProfileLayoutName = c.String(nullable: false, maxLength: 10),
                        NotificationsLayoutName = c.String(nullable: false, maxLength: 10),
                        AdminLayoutName = c.String(nullable: false, maxLength: 10),
                ...
                .ForeignKey("dbo.Theme", t => t.OrderStatusThemeId)
                ...
                c => new
                    {
                        ...
                        StatusEnteredPaymentInfo = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                .Index(t => new { t.ClientId, t.StoreFrontId, t.CartId, t.ProductId }, unique: true, name: "UniqueRecord")
                .Index(t => t.CreatedBy_UserProfileId)
                .Index(t => t.UpdatedBy_UserProfileId);
                ...
                c => new
                    {
                        ...
                        ShowIfEmpty = c.Boolean(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        StatusPaymentProcessed = c.Boolean(nullable: false),
                        StatusOrderShipped = c.Boolean(nullable: false),
                        StatusOrderDelivered = c.Boolean(nullable: false),
                        StatusFeedbackReceived = c.Boolean(nullable: false),
                ...
                .ForeignKey("dbo.UserProfile", t => t.UpdatedBy_UserProfileId)
                .ForeignKey("dbo.UserProfile", t => t.UserProfileId)
                .ForeignKey("dbo.Cart", t => t.OrderId)
                .Index(t => t.OrderId)
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.StoreFront", t => t.StoreFrontId)
                .ForeignKey("dbo.UserProfile", t => t.UpdatedBy_UserProfileId)
                .ForeignKey("dbo.Cart", t => t.PaymentId)
                .Index(t => t.PaymentId)
                .Index(t => new { t.ClientId, t.StoreFrontId, t.CartId }, unique: true, name: "UniqueRecord")
                .Index(t => t.CreatedBy_UserProfileId)
                .Index(t => t.UpdatedBy_UserProfileId);
                ...
                c => new
                    {
                        ...
                        LayoutName = c.String(nullable: false),
                        ClientId = c.Int(nullable: false),
                        CreateDateTimeUtc = c.DateTime(nullable: false),
                        CreatedBy_UserProfileId = c.Int(nullable: false),
                        UpdateDateTimeUtc = c.DateTime(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.StoreFrontConfiguration", "OrderStatusThemeId", "dbo.Theme");
            ...
            DropForeignKey("dbo.Payment", "PaymentId", "dbo.Cart");
            DropForeignKey("dbo.Order", "OrderId", "dbo.Cart");
            ...
            DropIndex("dbo.StoreFrontConfiguration", new[] { "OrderStatusThemeId" });
